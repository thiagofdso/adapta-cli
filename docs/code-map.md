...
- `src/adapta/services/debate_service.py` -> orquestração do debate por rodadas, leitura e gravação de configuração, suporte opcional a arquivo de persona por agente, upload único de anexos opcionais, conclusão final e emissão incremental
